...
const DATA_DIR = process.env.DATA_DIR || '/opt/prompt-hub/data';
...
globalThis.__promptHubData = globalThis.__promptHubData || { prompts: [], categories: [] };
var data = globalThis.__promptHubData;
globalThis.__promptHubLog = globalThis.__promptHubLog || [];
var log = globalThis.__promptHubLog;

// Auto-init: load data when module first loads
try { loadData(); } catch(e) { console.warn('[DB] Init error:', e.message); }
